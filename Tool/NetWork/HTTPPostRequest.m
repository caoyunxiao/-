...
//                                      };
    ...
    NSDictionary *headerFieldsDic = [NSDictionary dictionaryWithObjectsAndKeys:[NSString stringWithFormat:@"%ld",(long)bodyData.length],@"Content-Length", nil];
...
//                                      @"Content-Length":[NSString stringWithFormat:@"%ld",(long)bodyData.length]
//                                      };
    NSDictionary *headerFieldsDic = [NSDictionary dictionaryWithObjectsAndKeys:@"multipart/form-data;boundary=0xKhTmLbOuNdArY",@"Content-Type",[NSString stringWithFormat:@"%ld",(long)bodyData.length],@"Content-Length", nil];
