                  ...
                  cellForItemAtIndexPath:(NSIndexPath *)indexPath;
{
    ...
    ALAsset *asset = [_allArr objectAtQYQIndex:indexPath.row];
...
- (void)toggleSelectionAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.selectedIndexes.count == 0) {
        ...
        [Ti setTitle:[_ButtonTitles objectAtQYQIndex:Ti.tag-101] forState:UIControlStateNormal];
        
    }
    else
    {
        [[NSNotificationCenter defaultCenter] postNotificationName:@"HAVE_CHOSE_ONE_WAY" object:nil userInfo:nil];
